...
function GridWorld(theWorld)
{
    ...
    this.decision = function( x, y, policy, exploration_factor=0 ){
        ...
        return  [
            ...
            policy[y][x][2]+this.rand(exploration_factor),
            policy[y][x][3]+this.rand(exploration_factor)];
    };
    ...
    this.RandomPolicy_Init = function(scale){
        ...
        for(let i=0;i<this.theWorld.length;i++)
        {
            ...
            {
                sub_policy.push([this.rand(scale),this.rand(scale),this.rand(scale),this.rand(scale)]);
            }
